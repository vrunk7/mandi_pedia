                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: topSearchedFruits.length,
                      itemBuilder: (context, index) {
                        return buildCard(
                          topSearchedFruits[index]['fruit'],
                          fruitImageUrl(topSearchedFruits[index]['fruit']),
                        );
                      },
                    ),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      scrollDirection: Axis.horizontal,
                      itemCount: topSellingFruits.length,
                      itemBuilder: (context, index) {
                        return buildCard(
                          topSellingFruits[index]['fruit'],
                          fruitImageUrl(topSellingFruits[index]['fruit']),
                        );
                      },
                    ),
                  ),
